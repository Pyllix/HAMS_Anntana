  ...
  const columns = useMemo<Array<ColumnDef<typeof features, Asset>>>(() => {
    return [
      ...
      },
      {
        ...
        size: 125,
        cell: () => (
          <span className="inline-flex items-center justify-center gap-1.5 min-w-[90px] px-3 py-1 rounded-full text-xs font-semibold whitespace-nowrap bg-amber-50 text-amber-700 border border-amber-200">
